...
public class ClientExistsAndActivedValidate implements IValidations, Validation<ClientOutput> {
    private final FindApplicationBaseGateway<ClientOutput> findClientRepository;

    public ClientExistsAndActivedValidate() {
        this.findClientRepository = null;
    }

    @Deprecated(forRemoval = true)
    public ClientExistsAndActivedValidate(FindApplicationBaseGateway<ClientOutput> findClientRepository) {
