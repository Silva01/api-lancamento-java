...
public class ClientController {
    ...
    @PostMapping
    public ResponseEntity<NewAccountByNewClientResponseSuccess> createNewClient(@RequestBody ClientRequestDTO newClient) {
        return ResponseEntity.status(HttpStatus.CREATED).body(clientService.createNewClient(newClient));
    }
